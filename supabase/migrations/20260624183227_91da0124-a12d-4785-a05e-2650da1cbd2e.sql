...
BEGIN
  ...
  LOOP
    ...
    v_classe := CASE WHEN v_item.evento_origem = ANY(v_operacionais) THEN 'operacional' ELSE 'geral' END;
...
GRANT EXECUTE ON FUNCTION public.fn_fila_diagnostico_pendentes() TO authenticated;