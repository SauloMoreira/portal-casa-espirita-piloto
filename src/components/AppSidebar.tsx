...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Tratamentos sob minha coordenação", url: "/coordenador-tratamentos", icon: Heart, roles: ["coordenador_de_tratamento"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Fila de Notificações", url: "/central-notificacoes", icon: MessageCircle, roles: ["admin"] },
      { title: "Observabilidade", url: "/observabilidade", icon: Activity, roles: ["admin", "administrador_master"] },
      { title: "Relatórios", url: "/relatorios", icon: BarChart3, roles: ["admin", "entrevistador", "tarefeiro"] },
      { title: "Programação Padrão", url: "/programacao-padrao", icon: CalendarClock, roles: ["admin"] },
      { title: "Exceções Operacionais", url: "/excecoes-operacionais", icon: CalendarX, roles: ["admin"] },
